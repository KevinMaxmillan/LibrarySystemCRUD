...
public class ExceptionHandler : IExceptionHandler
{
    ...
    private static ProblemDetails CreateProblemDetails(Exception exception)
    {
        ...
        {
            NotFoundExceptions => CreateProblemDetails(StatusCodes.Status404NotFound,
                "Not Found", exception.Message),
            ValidationExceptions => CreateProblemDetails(StatusCodes.Status400BadRequest,
        ...
        if (exception is ValidationExceptions customValidationException)
        {
